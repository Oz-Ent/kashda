...
import { getSavingsData } from "@/lib/dataUtils";
import {
  formatCurrency,
  getRemainingDays,
...
const SavingsPage = () => {
  ...
  const [selectedGoal, setSelectedGoal] = useState(savingsData.goals[0]);
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="space-y-4">
            <h2 className="text-xl font-semibold text-[#e0e0e0]">Your Goals</h2>
              ...
              >
                <div className="flex justify-between items-start mb-3">
                  <div>
                    ...
                    <p className="text-sm text-[#a0a0a0]">{goal.category}</p>
                  </div>
          ...
          <div className="bg-[#3a005f] border border-[#4a007a] p-6 rounded-xl shadow-lg">
            ...
            <div className="space-y-4">
              <div>
                ...
                <p className="text-[#a0a0a0]">{selectedGoal.category} Goal</p>
              </div>

              <div className="grid grid-cols-2 gap-4">
                <div className="bg-[#2a004a] p-4 rounded-lg">
                  <p className="text-sm text-[#a0a0a0] mb-1">Current Amount</p>
                  <p className="text-xl font-bold text-[#6a0dad]">
                    {formatCurrency(selectedGoal.currentAmount)}
                  </p>
                </div>
                <div className="bg-[#2a004a] p-4 rounded-lg">
                  <p className="text-sm text-[#a0a0a0] mb-1">Target Amount</p>
              ...
              <div className="bg-[#2a004a] p-4 rounded-lg">
                <p className="text-sm text-[#a0a0a0] mb-1">Remaining to Goal</p>
